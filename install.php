                  ...
                  <div class="col-sm-4">
                     <div class="form-group">
                        ...
                        <select name="db_type" class="form-control" onchange="change_db_type()">
                           <option value="MYSQL"<?php if($db_type=='MYSQL') { echo ' selected=""'; } ?>><?php echo \L::install__mysql; ?></option>
                           <option value="POSTGRESQL"<?php if($db_type=='POSTGRESQL') { echo ' selected=""'; } ?>><?php echo \L::install__postgresql; ?></option>
                        </select>
                     </div>
                  </div>
                  <div class="col-sm-4">
